...
import { addConnectWallet } from "../../../../redux/features/connectWallet/connectWalletSlice";
    ...
    if (userData && profileImage !== null) {
      ...
      try {
        if (profileImage !== null) {
          ...
          await dispatch(addConnectWallet(formData));
          ...
          >
            ...
            <Stack>
              ...
              <Typography variant="subtitle2">
                Click the camera icon to add a wallet image
              </Typography>
            </Stack>
          </Stack>
