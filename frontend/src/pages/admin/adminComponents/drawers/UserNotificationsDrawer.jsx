...
import { adminGetUserNotifications } from "../../../../redux/features/notifications/notificationsSlice.js";

const UserNotificationsDrawer = ({
  open,
  handleClose,
  handleOpen,
  userNotificationLoader,
  setUserNotificationLoader,
}) => {
  ...
  useEffect(() => {
    if (userNotificationLoader) {
      const timer = setTimeout(() => {
        setUserNotificationLoader(false);
      }, 300);
      return () => clearTimeout(timer);
    }
  }, [userNotificationLoader, setUserNotificationLoader]);
...
export default UserNotificationsDrawer;
