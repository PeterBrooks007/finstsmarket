...
import AdminUserWithdrawalHistory from "../AdminUserWithdrawalHistory.jsx";


const AdminWithdrawalDrawer = ({
  open,
  handleClose,
  handleOpen,
  withdrawalLoader,
  ...
  }, [withdrawalLoader, setWithdrawalLoader]);
        ...
        {withdrawalLoader ? (
          ...
          >
            ...
            >
              ...
              {selectedWallet === "history" && <AdminUserWithdrawalHistory />}
            </Stack>
          </Box>
        )}
      </Drawer>
...
export default AdminWithdrawalDrawer;
