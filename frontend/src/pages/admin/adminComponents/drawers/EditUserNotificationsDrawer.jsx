...
import { adminUpdateUserNotification } from "../../../../redux/features/notifications/notificationsSlice.js";

const EditUserNotificationsDrawer = ({
  open,
  handleClose,
  handleOpen,
  editUserNotificationLoader,
  setEditUserNotificationLoader,
}) => {
  ...
  useEffect(() => {
    if (editUserNotificationLoader) {
      const timer = setTimeout(() => {
        setEditUserNotificationLoader(false);
      }, 200);
      return () => clearTimeout(timer);
    }
  }, [editUserNotificationLoader, setEditUserNotificationLoader]);
  ...
  const handleFormSubmit = async (values) => {
    ...
    await dispatch(adminUpdateUserNotification({ id, formData }));
    await handleClose();
  ...
  return (
    <>
      ...
      >
        {editUserNotificationLoader || isSemiLoading ? (
          <Box
            backgroundColor={colors.dashboardforeground[100]}
            width={"100%"}
            height={"100%"}
...
export default EditUserNotificationsDrawer;
