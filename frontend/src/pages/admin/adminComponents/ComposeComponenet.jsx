...
const ComposeComponenet = ({
  ...
  const [inputValue, setInputValue] = useState(
    (selectedMail && selectedMail?.userId?.email) || null
  ); // Default value here
  ...
  const allUsersAccount = Array.isArray(allUsers)
  ...
  const initiatialValue = {
    from: "Support Team",
    to: (selectedMail && selectedMail?.userId?.email) || "",
  ...
  }, [selectedMail, composeMessageType]);
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    ...
    const formData = {
      userId:
        composeMessageType === "compose"
          ? inputValue._id
          : selectedMail?.userId?._id,
      messages: [
        {
          to: composeMessageType === "compose" ? inputValue.email : values.to,
          from: "Support Team",
            ...
            {({
              ...
              <form action="" onSubmit={handleSubmit}>
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        slotProps={{
                          htmlInput: {
                            ...params.inputProps,
                            autoComplete: "to", // disable autocomplete and autofill
                          },
                        }}
                        InputProps={{
                          ...params.InputProps,
                        ...
                        sx={{
                          "& .MuiOutlinedInput-root": {
                            ...
                            "&:hover fieldset": {
                              borderTop: "1px solid lightgrey", // Change this to your desired hover color
                              borderBottom: "1px solid lightgrey", // Change this to your desired hover color
                            },
                            "&.Mui-focused fieldset": {
                              border: "1px solid grey", // Change this to your desired focused color
                            },
                          },
                        }}
                      />
                ...
                <Box
                  ...
                  maxHeight={{
                    xs: size.height - 400,
                    md: size.height < 967 ? "200px" : "400px",
                  }}
                  overflow={"hidden"}
                  pb={5}
                >
