          ...
          >
            <Box sx={{ flex: "50%" }}>
              ...
              <Typography variant={isMobile ? "subtitle2" : "body1"} color={"grey"}>
                FinstsMarket Investment offers state-of-the-art trading technology
                ...
                FinstsMarket Investment’s fully customizable market monitoring,
                charting and analysis tools help clients to identify and act
                instantly on trading opportunities. The first-of-its-kind
                FinstsMarket Investment Trading Planing offers hundreds of custom
                FinstsMarket Investment-compatible software products – indicators,
                strategies and other apps – that further amplify the power of
                the FinstsMarket Investment platform. With FinstsMarket Investment web
        ...
        <Container maxWidth="xl">
          ...
          >
            ...
            <Typography variant={isMobile ? "h4" : "h3"} sx={{ mb: 1 }} fontWeight={"500"}>
              ...
              <Typography variant={isMobile ? "subtitle2" : "body1"} color={"grey"}>
                At FinstsMarket Investment we believe in empowering traders to claim
                ...
                market access, and competitive pricing models. At FinstsMarket
