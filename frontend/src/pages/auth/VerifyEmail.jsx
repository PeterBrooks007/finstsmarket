...
const VerifyEmail = () => {
  ...
  useEffect(() => {
    if (isSuccess && isLoggedIn && user && user?.isEmailVerified) {
  ...
  useEffect(() => {
    if (verificationEmail === null && !user?.email && !isLoggedIn) {
      navigate("/auth/login");
      dispatch(RESET_AUTH());
    }
  }, [dispatch, isLoggedIn, navigate, user?.email, verificationEmail]);
              ...
              <Box>
                ...
                >
                  ...
                  >
                    ...
                    //   onChange={() => {}} // Keeps the input from being typed manually
                    //   readOnly
                    //   autoComplete="off"
                    //   sx={{
                    //     width: "40px",
                    ...
                    //       cursor: "default",
                    //       padding: "16px 8px",
                    //       pointerEvents: "none", // Prevents user from typing
                    //     },
                    //   }}
                    // />
