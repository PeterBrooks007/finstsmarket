  ...
  const saveProfile = async (values) => {
    ...
    const formData = {
      ...
      tradeData: {
        ...
        ...values,
        profitOrLossAmount: values.status === "Lose" ? values?.amount : values?.profitOrLossAmount ?? "",
    ...
    await dispatch(adminApproveUserTrade({ id, formData }));
    user?.role === "admin"
...
export default ApproveTradeOrder;
