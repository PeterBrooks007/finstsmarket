...
import { getUserNotifications } from "../../redux/features/notifications/notificationsSlice.js";
import { getAllUserTotalCounts } from "../../redux/features/totalCounts/totalCountsSlice.js";
          ...
          >
            ...
            >
              ...
              <Box m={0} height={"100%"} overflow={"auto"}>
                <Notifications allNotification={true} />
              </Box>
            </Stack>
          </Box>
        )}
