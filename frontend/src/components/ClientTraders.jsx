...
const ClientTraders = () => {
  ...
  useEffect(() => {
    if (singleUser) {
      dispatch(admingetUserExpertTrader(singleUser?.email));
    }
  }, [dispatch, singleUser?.email, singleUser]);
  ...
  const handleRemoveTrader = (id) => {
    ...
    dispatch(adminRemoveUserExpertTraderCopied({id, formData }));
    // console.log({id})
  };
          ...
          >
            <Stack>
              ...
              <Typography variant="subtitle2" px={1}>
                List of all traders this user copied
              </Typography>
            </Stack>
            ...
            <Button
              ...
              onClick={() => dispatch(admingetUserExpertTrader(singleUser?.email))}
            >
              Refresh
            </Button>
          </Stack>
